#ifndef COLOR_MAP_INCLUDED
#define COLOR_MAP_INCLUDED

//originally proposed at https://bids.github.io/colormap/

float3 jet(float t)
{
    return saturate(1.5 - abs(float3(3.0, 2.0, 1.0) - 4.0 * t));
}
